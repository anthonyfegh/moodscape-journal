    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed right-0 top-0 h-screen w-80 bg-card/95 backdrop-blur-md border-l shadow-lg p-6 overflow-hidden"
          style={{
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p 
                className="text-lg font-medium capitalize transition-colors duration-700"
