 ...
 */
export const BeingCanvas = ({ renderState, className = "w-full h-full", enableControls = false }: BeingCanvasProps) => {
  ...
  return (
    <div className={`${className} bg-black/80 rounded-xl`}>
      ...
      >
        ...
        {enableControls && <OrbitControls enableZoom={true} enablePan={true} enableRotate={true} />}
      </Canvas>
    </div>
  );
};
